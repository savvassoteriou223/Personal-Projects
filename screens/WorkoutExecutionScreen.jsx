                ...
                {(() => {
                  ...
                  return insight ? (
                    <View style={{ backgroundColor: colors.accentSoft, borderRadius: 10, borderWidth: 1, borderColor: colors.accentHair, padding: 12, marginTop: 8 }}>
                      ...
                      {insight.metric && <Text style={{ color: colors.accent, fontSize: 11, fontWeight: '700', marginTop: 6 }}>{insight.metric.this} vs {insight.metric.control} · {insight.metric.method}</Text>}
...
const styles = StyleSheet.create({
  ...
  minimizeText: { color: colors.textPrimary, fontSize: 28, lineHeight: 26, marginTop: -6, fontWeight: '400' },
  cancelBtn: { padding: 8, paddingLeft: 4 },
  cancelText: { color: colors.textSubtle, fontSize: 20 },
  ...
  swipeHintLabel: { fontSize: 11, color: colors.textFaint, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 2 },
  ...
  restSkip: { color: colors.textSubtle, fontSize: 15 },
  ...
  doneBadgeText: { fontSize: 13, color: colors.accent, fontWeight: '600' },
  readinessBadge: {
    alignSelf: 'flex-start', fontSize: 11, fontWeight: '700', color: colors.warning,
  ...
  prescLabel: { fontSize: 11, color: colors.textSubtle, marginTop: 2, textAlign: 'center' },
  ...
  contraBannerText: { fontSize: 13, color: colors.warning, lineHeight: 16 },
  ...
  replaceGroupHdr: { color: colors.textSubtle, fontSize: 13, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 6 },
  ...
  setField: { fontSize: 20, fontWeight: '700', color: colors.textPrimary, letterSpacing: -0.4, minWidth: 42, paddingVertical: 2 },
  setFieldDone: { color: colors.textMuted },
  setUnit: { fontSize: 13, color: colors.textFaint, fontWeight: '600', marginLeft: 2 },
  ...
  setMarkTick: { color: colors.textOnLight, fontSize: 15, fontWeight: '800', lineHeight: 16 },
  setNum: { fontSize: 15, color: colors.textSubtle, textAlign: 'center' },
  ...
  nextExLeft: { flex: 1 },
  nextExLabel: { fontSize: 11, color: colors.textFaint, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 3 },
  ...
  finishBackText: { color: colors.textSubtle, fontSize: 15 },
  ...
  finishStatVal: { fontSize: 20, fontWeight: '700', color: colors.textPrimary, marginBottom: 4 },
  finishStatLabel: { fontSize: 11, color: colors.textSubtle },
  rpeLabel: { fontSize: 15, fontWeight: '500', color: colors.textPrimary, marginBottom: 12 },
  ...
  rpeBtnText: { color: colors.textSubtle, fontSize: 13, fontWeight: '500' },
  rpeBtnTextActive: { color: colors.surfaceRaised },
  rpeSub: { fontSize: 13, color: colors.textSubtle, lineHeight: 18, marginBottom: 24 },
  ...
  overloadEx: { fontSize: 13, fontWeight: '600', color: colors.textPrimary, marginBottom: 2 },
  ...
  coachTitle: { fontSize: 20, fontWeight: '700', color: colors.textPrimary },
  coachClose: { fontSize: 15, color: colors.textSubtle, fontWeight: '500' },
  coachSub: { fontSize: 13, color: colors.textFaint, marginTop: -6 },
  coachAnswerWrap: { maxHeight: 160, backgroundColor: colors.surfaceInset, borderRadius: 10, padding: 12 },
  coachAnswerText: { fontSize: 15, color: colors.textSecondary, lineHeight: 21 },
  coachInput: { backgroundColor: colors.control, borderRadius: 10, padding: 14, color: colors.textPrimary, fontSize: 15, minHeight: 56, textAlignVertical: 'top' },
  ...
  plateTitle: { fontSize: 20, fontWeight: '700', color: colors.textPrimary, marginBottom: 20 },
  plateBarRow: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 16 },
  plateBarLabel: { fontSize: 13, color: colors.textSubtle, flex: 1 },
  ...
  plateInput: { backgroundColor: colors.control, borderRadius: 10, padding: 14, color: colors.textPrimary, fontSize: 20, fontWeight: '600', marginBottom: 20, textAlign: 'center' },
  plateNote: { fontSize: 13, color: colors.textSubtle, textAlign: 'center', marginBottom: 16 },
  plateResult: { marginBottom: 20 },
  plateResultLabel: { fontSize: 11, fontWeight: '700', color: colors.textFaint, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 12 },
  ...
  plateAchieved: { fontSize: 13, color: colors.textSubtle },
  plateCloseBtn: { backgroundColor: colors.control, borderRadius: 12, paddingVertical: 14, alignItems: 'center' },
  plateCloseBtnText: { color: colors.textMuted, fontSize: 15, fontWeight: '600' },
});