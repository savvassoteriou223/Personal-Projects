...
const styles = StyleSheet.create({
  ...
  greeting: { fontSize: 28, fontWeight: '800', color: colors.textPrimary, letterSpacing: -1.2, lineHeight: 38 },
  ...
  readinessAdvice: { fontSize: 13, marginTop: 8, lineHeight: 18 },
  ...
  blockBannerTitle: { fontSize: 15, fontWeight: '700', color: colors.accent, marginBottom: 3 },
  blockBannerSub: { fontSize: 13, color: colors.textMuted, lineHeight: 17 },
  ...
  sessionLabel: { fontSize: 11, color: colors.textSubtle, fontWeight: '700', letterSpacing: 1, marginBottom: 6, textTransform: 'uppercase' },
  sessionName: { fontSize: 20, fontWeight: '800', color: colors.textPrimary, marginBottom: 4, letterSpacing: -0.4 },
  ...
  exPreviewDetail: { fontSize: 13, color: colors.textSubtle },
  moreText: { fontSize: 13, color: colors.textSubtle, paddingLeft: 13 },
  ...
  restTitle: { fontSize: 20, fontWeight: '700', color: colors.textPrimary, marginBottom: 6 },
  ...
  cardioRowType:      { fontSize: 15, fontWeight: '600', color: colors.textPrimary, marginBottom: 2 },
  cardioRowSub:       { fontSize: 11, color: colors.textSubtle },
  cardioRowRight:     { alignItems: 'flex-end' },
  cardioRowDur:       { fontSize: 15, fontWeight: '600', color: colors.textPrimary, marginBottom: 2 },
  ...
  recoveryMore: { fontSize: 11, color: colors.textSubtle, fontWeight: '600' },
  ...
  recoveryPillText: { fontSize: 11, fontWeight: '700' },
  recoveryHeader: {
    flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',
    paddingHorizontal: 20, paddingTop: 20, paddingBottom: 14,
  },
  recoveryHeaderTitle: { fontSize: 20, fontWeight: '700', color: colors.textPrimary, letterSpacing: -0.4 },
  ...
  volumeLegendLabel: { fontSize: 11, color: colors.textSubtle },
  volumeRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 12, gap: 10 },
  volumeNameCol: { width: 100 },
  volumeMuscleName: { fontSize: 13, color: colors.textSecondary, fontWeight: '500' },
  volumeTargetLabel: { fontSize: 11, color: colors.textMuted, marginTop: 2 },
  ...
  volumeDetailToggleText: { fontSize: 13, fontWeight: '600', color: colors.accent },
  ...
  volumeHeadName: { fontSize: 13, color: colors.textMuted, fontWeight: '500' },
  ...
  junkWarningTitle: { fontSize: 13, fontWeight: '700', color: colors.danger },
  ...
  deloadTitle: { fontSize: 15, fontWeight: '700', color: colors.textPrimary, marginBottom: 2 },
  deloadTrigger: { fontSize: 11, color: colors.textPrimary, fontWeight: '600' },
  deloadReason: { fontSize: 13, color: colors.textSubtle, lineHeight: 18, marginBottom: 10, fontStyle: 'italic' },
  ...
  deloadStatValue: { fontSize: 15, fontWeight: '700', color: colors.textPrimary, marginBottom: 2 },
  deloadStatLabel: { fontSize: 11, color: colors.textFaint, textAlign: 'center' },
  ...
  deloadDietNoteText: { fontSize: 13, color: colors.accent, lineHeight: 18 },
  ...
  deloadInstructionText: { fontSize: 13, color: colors.textMuted, lineHeight: 19, flex: 1 },
  deloadScience: { fontSize: 11, color: colors.textFaint, marginTop: 12, fontStyle: 'italic', lineHeight: 14 },
  ...
  plateauExercise: { fontSize: 15, fontWeight: '700', color: colors.textPrimary, marginBottom: 2 },
  plateauDays: { fontSize: 11, color: colors.textSubtle },
  plateauMessage: { fontSize: 13, color: colors.textMuted, lineHeight: 19, marginBottom: 12 },
  ...
  plateauIntervention: { fontSize: 13, color: colors.textMuted, lineHeight: 19, marginBottom: 3, paddingLeft: 4 },
  plateauScience: { fontSize: 11, color: colors.textFaint, marginTop: 10, fontStyle: 'italic', lineHeight: 14 },
  ...
  coachNudgeTitle: { fontSize: 15, fontWeight: '700', color: colors.textPrimary, flex: 1 },
  coachNudgeBody: { fontSize: 13, color: colors.textMuted, lineHeight: 19 },
  coachNudgeHint: { fontSize: 13, color: colors.info, fontWeight: '600', marginTop: 8 },
  ...
  lastSessionName: { fontSize: 15, fontWeight: '600', color: colors.textPrimary, marginBottom: 3 },
  lastSessionDate: { fontSize: 13, color: colors.textSubtle },
  lastSessionRight: { alignItems: 'flex-end', gap: 3 },
  lastSessionStat: { fontSize: 15, fontWeight: '600', color: colors.textPrimary },
  ...
  modalSub: { fontSize: 13, color: colors.textSubtle, marginBottom: 20 },
  modalSectionLabel: { fontSize: 11, fontWeight: '700', color: colors.textFaint, letterSpacing: 1, textTransform: 'uppercase', marginBottom: 14 },
  ...
  muscleCount: { fontSize: 13, fontWeight: '700', color: colors.textPrimary, width: 24, textAlign: 'right' },
