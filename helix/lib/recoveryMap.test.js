...
// Fixtures carry reps/weight/set_type because real completed_sets rows do, and
// lastTrainedPerMuscle now filters warm-ups and blank sets the same way
// volumeEngine does. Without them every fixture reads as a set that was toggled
// done but never performed. See trapsRecovery.test.js for that filter's own cases.
const s = (name, patternKey) => ({
  exercise_name: name, pattern_key: patternKey, session_id: 's1',
  reps: 10, weight_kg: 40, set_type: 'working',
});
